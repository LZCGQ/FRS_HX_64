...
namespace DataAngineSet.BLL
{
	...
	{
		private readonly DataAngineSet.DAL.device dal=new DataAngineSet.DAL.device();
		public device()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<DataAngineSet.Model.device> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DataAngineSet.Model.device> DataTableToList(DataTable dt)
		{
			List<DataAngineSet.Model.device> modelList = new List<DataAngineSet.Model.device>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DataAngineSet.Model.device model;
