...
namespace DataAngineSet.BLL
{
	...
	{
		private readonly DataAngineSet.DAL.hitrecord_detail dal=new DataAngineSet.DAL.hitrecord_detail();
		...
		/// 获得数据列表
		/// </summary>
		public List<DataAngineSet.Model.hitrecord_detail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DataAngineSet.Model.hitrecord_detail> DataTableToList(DataTable dt)
		{
			List<DataAngineSet.Model.hitrecord_detail> modelList = new List<DataAngineSet.Model.hitrecord_detail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DataAngineSet.Model.hitrecord_detail model;
